...
import 'page.dart';
import 'widgets.dart';
import 'agora_service.dart'; // Import LoginPage
...
class QuickStartPage extends FastExamplePage {
  ...
  Widget build(BuildContext context) {
    ...
    bool isLoggedIn = false; // Replace this with your actual login check

    return isLoggedIn ? const QuickStartBody() : LoginPage(); // 切換頁面
  }
}
...
import 'page.dart';
import 'widgets.dart';
import 'package:fastboard_flutter_example/agora_service.dart'; // Import LoginPage
